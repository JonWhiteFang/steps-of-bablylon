...
enum class EnemyType(
    ...
    FAST(2.0, 0.5, 0.5, "2x speed, lower health, overwhelms in groups"),
    TANK(0.5, 5.0, 2.0, "Slow, massive health, high damage"),
    RANGED(1.0, 0.8, 1.5, "Stops at distance, fires projectiles"),
    BOSS(0.5, 10.0, 3.0, "Every 10 waves, huge health, special abilities"),
